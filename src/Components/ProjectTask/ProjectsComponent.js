...
const ProjectsComp = (props) => {
    ...
    return (
        <Comp>
            ...
            <div id="projectInstance" key={props.project.id} onClick={() => {setShowProject(showProject === 'none' ? 'block' : 'none'); 
                                 setShowBTN(showProject === 'none' ? 'none' : 'block')}} style={{display: `${showProject}`}}>
